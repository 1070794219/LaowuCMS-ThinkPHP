<?php if (!defined('THINK_PATH')) exit();?><title>紧急救援</title>
...
<form class="layui-form m-send-main" action="<?php echo U('User/sendFunc');?>" method="post">
  ...
  <div class="layui-form-item">
    <button class="layui-btn" lay-submit="" lay-filter="demo2" style="width:50%;margin-left:35%;background:#ce6600">提交</button>
  </div>
</form>
